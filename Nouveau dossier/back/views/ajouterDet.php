                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                ...
                                <li>
                                    <a href="ajouterCat.php">Add Category</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="title1" name="title1" placeholder="first title" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="description1" id="description1" rows="9" placeholder="Content..." class="form-control"></textarea>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="title2" name="title2" placeholder="second title" class="form-control">
                                                    <!--<small class="form-text text-muted"></small>-->
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="textarea-input" class=" form-control-label">Second Decription</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <textarea name="description2" id="description2" rows="9" placeholder="Content..." class="form-control"></textarea>
                                                </div>
                                            </div>
