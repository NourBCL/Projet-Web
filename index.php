  ...
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_left">
      <ul class="nospace">
        ...
        <li><a href="pages/nutritionists.html">nutri</a></li>
    ...
    <section id="introblocks">
      ...
      <ul class="nospace group">
        <li class="one_third first">
          <article><a href="pages/nutritionists.html"><i class="fas fa-allergies"></i></a>
            <h6 class="heading">Our Nutritionists</h6>
            <p>you can contact our Nutritionists Here[&hellip;]</p>
            <footer><a class="btn" href="pages/nutritionists.html">Read More</a></footer>
          </article>
        </li>
        <li class="one_third">
