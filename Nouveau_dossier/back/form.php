            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="table.html">
                                <i class="fas fa-table"></i>Tables</a>t
                        </li>
                        <li>
                            <a href="form.html">
                                <i class="far fa-check-square"></i>Evens</a>
                        </li>
                        <li>
                                    ...
                                    <div class="card-body card-block">
                                        <div class="form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="text-input" placeholder="Event's Id" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input" name="text-input" placeholder="new name" class="form-control">
                                                <!--<small class="form-text text-muted"></small>-->
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="date" id="date-input" name="date-input" placeholder="date" class="form-control">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-8">
                                                <div class="col col-md-3">
                                                    <label for="place-input" class=" form-control-label">New place</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="place-input" name="place-input" placeholder="new place" class="form-control">
                                                    <br>
                                            ...
                                            <div class="col-12">
                                                <div class="col col-md-3">
                                                    <label for="textarea-input" class=" form-control-label">Edit decription</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                        ...
                                        <div class="form-group">
                                            <div class="col col-md-3">
                                                <label for="categorie" class=" form-control-label">Edit categorie</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label for="file-input" class=" form-control-label">New picture</label>
                                            </div>
                                            <div class="col-12 col-md-9">
                                                <input type="file" id="picture-input" name="picture-input" class="form-control-file">
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body card-block">
                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="place-input" name="place-input" placeholder="place" class="form-control">
                                                   <!-- <small class="help-block form-text">Please enter a complex password</small>-->
                                                </div>
                                            </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body card-block">
                                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                ...
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                        <label for="text-input" class=" form-control-label">Event's Id</label>
                                                    </div>
                                                    <div class="col-12 col-md-9">
                                                        <input type="text" id="text-input" name="text-input" placeholder="Id" class="form-control">
                                                        <!--<small class="form-text text-muted"></small>-->
                                                    </div>
                                                </div>
