                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <form action="../../controllers/product/<?php  echo ($actionType=="ADD" ? "create.php":"update.php") ?>" method="post" enctype="multipart/form-data">
                                        <input name="id" hidden type="number" value='<?php echo ($actionType == "EDIT"? $prod[0]->id:"" ) ?>'> 
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Name</label>
                                                <input value='<?php echo ($actionType == "EDIT"? $prod[0]->name:"" ) ?>' required id="cc-pament" name="name" type="text" class="form-control" aria-required="true" aria-invalid="false" >
                                            </div>
                                            <div class="form-group has-success">
                                                <label for="cc-name" class="control-label mb-1">Price</label>
                                                <input  value='<?php echo ($actionType == "EDIT"? $prod[0]->price:"" ) ?>' required min="1" id="cc-name" name="price" type="number" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card"
