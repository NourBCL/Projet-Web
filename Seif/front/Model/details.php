<?PHP
    class Details{
        ...
        public function __construct($image1,$title1, $description1, $title2, $description2, $map, $gallery1, $gallery2, $gallery3, $gallery4, $gallery5, $gallery6, $nom,$date ){
        ...
        function getNomDetails(){
            return $this->nom;
        }
        public function setNomDetails($nom){
             $this->nom=$nom;
        }
        function getImage1Details(){
            return $this->image1;
        }
        public function setImage1Details($image1){
             $this->image1=$image1;
        }
