   ...
   include ('../Model/details.php');
    ...
    class DetailsC {
        ...
        function ajouterDet($details){
			$sql="INSERT INTO eventdetails (image1 , title1, description1 , title2 , description2 , map , gallery1 , gallery2 , gallery3 , gallery4 , gallery5 , gallery6, nom,) 
			VALUES (:image1 , :title1 , :description1 , :title2 , :description2 , :map , :gallery1 , :gallery2 , :gallery3 , :gallery4 , :gallery5 , :gallery6, :nom)";
