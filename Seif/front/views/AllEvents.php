               ...
               <div class="wrapper row3">  
                <section class="hoc container clear"> 
                    ...
                    <center>
                        <h6>Evenements</h6> 
                     <?php
                        $pdo_conn = new PDO( 'mysql:host=localhost;dbname=project', 'root', '' );
                        $search_keyword = '';
                        ...
                        $sql = 'SELECT * FROM event WHERE nom LIKE :keyword ORDER BY id ASC ';
                        $query = $sql;
                        $pdo_statement = $pdo_conn->prepare($query);
                        $pdo_statement->bindValue(':keyword', '%' . $search_keyword . '%', PDO::PARAM_STR);
                        $pdo_statement->execute();
                        $listeEvent = $pdo_statement->fetchAll();
                        ?> 
                        <form action="" method="post" class="d-flex">
                            <input type="text" placeholder="enter name..." name="search[keyword]"
                                value="<?php echo $search_keyword; ?>" required="">
                            <button class="btn">
                        ...
                        <form method="POST" action="Filtre.php">
                                            <footer>
                                                <input type="submit" name="sort with date" class="btn" value="sort with date">
                        ...
                        <article>
                            <div class="excerpt">
                                ...
                                <div class="excerpt">
                                    ...
                                    <footer><a class="btn" href="showDetails.php?id=<?PHP echo $evn['id']; ?>">Read More</a></footer>
                                </div>
                            </div>
                        </article>
                    </li>
