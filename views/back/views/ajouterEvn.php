                                    ...
                                    <div class="card-body card-block">
                                        <form action="" method="POST"  class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <input type="checkbox" name=categorie value="sport" id="categotie"> sport
                                                <input type="checkbox" name=categorie value="cat1" id="categotie"> cat1
                                                <input type="checkbox" name=categorie value="cat2" id="categotie"> cat2
