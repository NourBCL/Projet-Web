  ...
  <header id="header" class="hoc clear"> 
    ...
    <div id="logo" class="one_quarter first">
      <div class="col-md-5 col-md-push-1 col-sm-6">
        <a href="index.html" id="templatemo_logo"><img style ="height: 111px; width: 163px; position: relative; top: -20px; position: relative; right: 10px;"src="templatemo_logo_2.png" alt="1,2,3 Diet" class="headerLogo"></a>
        <img style ="height: 50px; width: 200px; position: relative; top: -60px; position: relative; right: -70px;"src="slogon.png" alt="slogon" class="headerLogo"></a>
    </div>
...
<div class="wrapper row3">
  <section class="hoc container clear"> 
    <!-- ################################################################################################ -->
    <div class="sectiontitle">
      <h5 class="heading">evenements</h5>
      <p></p>
    </div>
    <ul class="nospace group latest">
      <li class="one_third first">
        <article>
          <time datetime="2045-04-06T08:15+00:00"><i class="far fa-calendar-alt rgtspace-5"></i> 30<sup>th</sup> November 2020 @ 15:00pm</time>
          <div class="excerpt">
            <h6 class="heading">My Yoga Journey</h6>
            <img src="Yoga.jpg" alt="Yoga">
            <p>Yoga can help you in innumerable ways, as it empowers your body, mind and soul to fight the stress and everyday problems of life. </p>
      ...
      <li class="one_third">
        <article>
          <time datetime="2045-04-05T08:14+00:00"><i class="far fa-calendar-alt rgtspace-5"></i> 05<sup>th</sup> December 2020 @ 14:00pm</time>
          <div class="excerpt">
            <h6 class="heading">Better Ride</h6>
            <img src="cycliste affiche.jpg" alt="affiche">
            <p>Pedaling is very good physical exercise, even at low intensity. It allows everyone to stay active at their own pace and improve their physical condition.</p>
            
         
            <footer><a class="btn" href="Page2/event2.html">Read More</a></footer>
          </div>
        </article>
      </li>
      <li class="one_third">
        <article>
          <time datetime="2045-04-04T08:13+00:00"><i class="far fa-calendar-alt rgtspace-5"></i> 15<sup>th</sup> December 2020 @ 13:00pm</time>
          <div class="excerpt">
            <h6 class="heading">Let's have fun together</h6>
            <img src="affiche.png" alt="affiche">
            <p>In all circumstances, with a little grass on the ground and a few hot rays of sun, hop, we can set up our picnic! Near work, at noon. </p>
           
            <footer><a class="btn" href="Page2/event4.html">Read More</a></footer>
          </div>
        </article>
      </li>
    </ul>
